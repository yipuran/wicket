...
public class Url implements Serializable
{
	...
	/**
	 * Flags the URL as relative to the application context. It is a special type of URL, used internally to hold the client data: protocol + host + port + relative segments
	 * 
